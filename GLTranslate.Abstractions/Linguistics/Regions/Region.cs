...
using GLTranslate.Abstractions.Linguistics.Regions.Codes;
    ...
    IEquatable<Region>
{
        ...
        IEnumerable<RegionCode> codes)
    {
        ...
        // Эффективная проверка на пустоту без двойной перечисляемости
        ICollection<RegionCode> codesCollection = codes as ICollection<RegionCode> ?? [.. codes];
        ...
        Codes = new CodeSet<RegionCode>(codesCollection);
    }
